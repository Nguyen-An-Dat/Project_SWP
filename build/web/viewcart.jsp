...
<!--                                                                <input type="date" hidden name="dateTime" id="dateTime"  />-->
                            ...
                            <aside class="col-lg-3">
                                <div class="summary summary-cart">
                                    ...
                                    <a href="checkout" class="btn btn-outline-primary-2 btn-order btn-block">CHECKOUT</a>
                                </div><!-- End .summary -->

                                <a href="listproduct" class="btn btn-outline-dark-2 btn-block mb-3"><span>CONTINUE SHOPPING</span><i class="icon-refresh"></i></a>
                            </aside><!-- End .col-lg-3 -->
                        </div><!-- End .row -->
                    </div><!-- End .container -->
                </div><!-- End .cart -->
